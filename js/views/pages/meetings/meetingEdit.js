...
class MeetingEdit extends Component {
    ...
    render(meeting) {
        return new Promise(resolve => {
            ...
            if (meeting) {
                const { gameName, day, time, place, description } = meeting;
...
`;
    ...
    setActions() {
        ...
        btnSaveMeeting.addEventListener('click', () => this.editMeeting(editDay, editTime, editPlace, editDescription));
    }

    editMeeting(editDay, editTime, editPlace, editDescription) {
