    ...
    return new Promise(resolve => {
      ...
      <div class ="form-login-container">
          ...
          <form class="form-login" action="">
            <p class="form-login__title">Sign in</p>
            ...
            <input class="form-login__btn-login button" type="submit" value="Login">
            <input class="form-login__btn-registration button" type="submit" value="Sign up">
          </form>   
      </div>           
            `);
    });
